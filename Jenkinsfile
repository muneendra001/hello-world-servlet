...
// for display purposes
      ...
      git 'https://github.com/muneendra001/hello-world-servlet.git'
...
post {
        success {
            mail to:"munnaa009@gmail.com", subject:"SUCCESS: ${currentBuild.fullDisplayName}", body: "Build success"
        }
        failure {
            mail to:"munnaa009@gmail.com", subject:"FAILURE: ${currentBuild.fullDisplayName}", body: "Build failed"
        }
    }       
}
